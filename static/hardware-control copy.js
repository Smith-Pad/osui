...
function VOLUME_CONTROLLER() {
        ...
        function controlsvolumeDown() {
                document.getElementById('controls-volume-down').addEventListener('click', function () {
                        var requestControlsVolumeDown  = new XMLHttpRequest();

                        /**
                         * See the index.py
                         */
                        requestControlsVolumeDown.open('POST', '/controls_volume_rocker_down');

                        requestControlsVolumeDown.send();
                });
        }
